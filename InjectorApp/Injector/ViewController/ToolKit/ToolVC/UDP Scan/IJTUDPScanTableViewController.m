//
//  IJTUDPScanTableViewController.m
//  Injector
//
...
#import "IJTUDPScanTableViewController.h"
#import "IJTUDPScanResultTableViewController.h"
@interface IJTUDPScanTableViewController ()
...
@implementation IJTUDPScanTableViewController
...
- (void)viewDidLoad {
    ...
    [self.actionButton addTarget:self action:@selector(gotoUDPScanVC) forControlEvents:UIControlEventTouchUpInside];
    ...
    self.intervalTextField.text = @"500000";
...
- (void) gotoUDPScanVC {
    ...
    IJTUDPScanResultTableViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"UDPScanResultVC"];
