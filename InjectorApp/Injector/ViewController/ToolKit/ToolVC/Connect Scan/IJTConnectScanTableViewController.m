//
//  IJTConnectScanTableViewController.m
//  Injector
//
...
#import "IJTConnectScanTableViewController.h"
#import "IJTConnectScanResultTableViewController.h"

@interface IJTConnectScanTableViewController ()
...
@implementation IJTConnectScanTableViewController
...
- (void)viewDidLoad {
    ...
    [self.actionButton addTarget:self action:@selector(gotoConnectScanVC) forControlEvents:UIControlEventTouchUpInside];
...
- (void)gotoConnectScanVC {
    ...
    IJTConnectScanResultTableViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"ConnectScanResultVC"];
