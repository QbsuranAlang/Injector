...
#import "IJTMDNSTableViewController.h"
#import "IJTArgTableViewCell.h"
#import "IJTMDNSResultTableViewController.h"

@interface IJTMDNSTableViewController ()
...
@implementation IJTMDNSTableViewController
...
- (void)gotoMDNSVC {
    ...
    IJTMDNSResultTableViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"mdnsResultVC"];
